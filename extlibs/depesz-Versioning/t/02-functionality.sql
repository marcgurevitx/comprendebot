BEGIN;
    ...
    SELECT results_eq(
        'SELECT patch_name COLLATE "C", applied_tsz, applied_by COLLATE "C", requires, conflicts  FROM _v.patches',
        $$SELECT 'first_patch'::text COLLATE "C" as patch_name, now() as applied_tsz, current_user::TEXT COLLATE "C" as applied_by, '{}'::TEXT[] as requires, '{}'::TEXT[] as conflicts$$,
